...
function Navbar() {
    ...
    function handlePreferenWindow(){
      ...
      console.log('preference',preferenceWindow);
    }
         ...
         {/* logo */}
          ...
          <div className="px-3 my-0 hidden md:visible text-center md:flex md:basis-6/12">
            <ul className="w-[90%] flex sm:space-x-2 text-slate-100 font-semibold">
              <li className=" py-5 px-3 border-gray-900 leading-3 cursor-pointer"><NavLink to="/league">{getTranslation('Leagues',lang)}</NavLink></li>
              <li className=" py-5 px-3 border-gray-900 leading-3 cursor-pointer"><NavLink to="/team">{getTranslation('Teams',lang)}</NavLink></li>  
              <li className=" py-5 px-3 border-gray-900 leading-3 cursor-pointer" onClick={()=>handlePreferenWindow()}>{getTranslation('Preferences',lang)}</li>  
              <li className=" py-5 px-3 border-gray-900 leading-3 cursor-pointer" onClick={()=>handleSearchWindow()}>{getTranslation('Search',lang)}</li>
            </ul>
          </div>
      </div>
    ...
    <div id="hamburger_items" ref={hamburger_items} className="fixed w-full h-0 overflow-y-hidden my-auto top-16 left-0 text-center z-10 ">
      <ul className="myul w-full flex flex-col items-center px-2 bg-slate-900 z-10 text-slate-100">
        <li className="liclass w-full  py-2 border-b border-gray-600 border-solid"><NavLink to='/league'>{getTranslation('Leagues',lang)}</NavLink></li>
        <li className="liclass w-full  py-2 border-b border-gray-600 border-solid"><NavLink to='/team'>{getTranslation('Teams',lang)}</NavLink></li>
        <li className="liclass w-full  py-2 border-b border-gray-600 border-solid" onClick={()=>handlePreferenWindow()}>{getTranslation('Preferences',lang)}</li> 
        <li className="liclass w-full  py-2 border-b border-gray-600 border-solid" onClick={()=>handleSearchWindow()}>{getTranslation('Search',lang)}</li>                      

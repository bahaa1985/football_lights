            ...
            {               
                <>
...

                    {
                        ...
                        return (
                            <div key={i} className="flex justify-center mx-auto my-2 border-b border-b-black border-solid">
                        ...
                        {/* Match calendar */}
                            ...
                            {/* Fixture Teams */}
                            <div className={`p-auto my-2 ${type === "league" ? "w-[60%] flex justify-between" : "w-[75%] block"} `} key={i}>
                                ...
                                <div className="flex justify-center items-center w-full my-1">
                                    ...
                                    <NavLink className="w-[50%] text-center"  to={`/teams/${elem.teams.home.id}`}>
                                ...
                                {/* Away team */}
                                <div className={`flex justify-center items-center w-full my-1 ${type === "league" ? "flex-row-reverse" : "justify-start"}`}>
                                    
                                    <img src={elem.teams.away.logo} loading="lazy" className="w-10 h-10"  alt={elem.teams.away.name} />
                                    
                                    <NavLink className="w-[50%] text-center" to={`/teams/${elem.teams.away.id}`}>
                            ...
                            <div className="flex items-center">
                                <button className="p-1 bg-emerald-600 text-slate-50 rounded-sm hover:bg-emerald-500">Deatils</button>
                            </div>                      
                        </div>
                    )})
                }

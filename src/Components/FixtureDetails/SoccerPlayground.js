...
const SoccerPlayground = (props) => {
    ...
    <div className="relative w-90% sm:w-[350px] md:w-[450px] h-[680px] md:h-[800px] mx-auto border-2 bg-slate-500 border-slate-50">
      ...
      {/* Center Line */}
      <div className="absolute top-1/2 left-0 w-full h-[2px] bg-slate-50 transform -translate-y-1/2"></div>

      {/* Center Circle */}
      <div className="absolute top-1/2 left-1/2 w-[120px] h-[120px] border-2 border-slate-50 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>

      {/* Top Half */}
      <div className="absolute top-0 left-0 w-full h-1/2">
        {/* Goal Area */}
        <div className="absolute top-0 left-1/2 w-[100px] h-[40px] border-2 border-slate-50 transform -translate-x-1/2"></div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-1/2">
        {/* Goal Area */}
        <div className="absolute bottom-0 left-1/2 w-[100px] h-[40px] border-2 border-slate-50 transform -translate-x-1/2"></div>

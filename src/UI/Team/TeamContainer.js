                            ...
                            <div className="bg-slate-100 p-6 rounded-lg shadow-inner mb-4">
                                ...
                                <div className="flex flex-wrap gap-4 justify-center">
                                    {teams.map((team, index) => (
                                        <button
                                            key={index}
                                            className={`w-32 cursor-pointer flex flex-col items-center px-3 py-2 rounded-lg transition border-2 ${team.id === selectedTeam ? 'border-blue-600 bg-blue-50 shadow'
